                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <div class="mb-3">
                              ...
                              <input type="text" class="form-control" name="value_setting" placeholder="value" value="<?= $adver['value_setting']?>">
                            </div>
                          </div>
                          <div class="modal-body">
                            <div class="row">
                              ...
                              <div class="col-lg-16">
                                <div>
                                  ...
                                  <textarea class="form-control" name="text"><?= $adver['text']?></textarea>
                                </div>
                              </div>
                            </div>
                          </div>
